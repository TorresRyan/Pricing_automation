...
it('Postcode 2000', () => {
            ...
            cy.fixture('BRZ2024').then( (data)=>{
    //POSTCODE 2000
    cy.visit('https://www.subaru.com.au/configure/models')
                .wait(1000)
                cy.fixture('BRZ2024').then( (data)=>{

    //POSTCODE 2000
            cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('2000')
...
it('Postcode 2250', () => {
            ...
            //POSTCODE 2250
                    cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('2250')
...
it('Postcode 2264', () => {
            ...
            //POSTCODE 2264
                    cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('2264')
 ...
 it('Postcode 2311', () => {
    ...
    //POSTCODE 2311
            cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('2311')
...
//POSTCODE 2361
    cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('2361')
...
//POSTCODE 2640
    cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('2640')
...
//POSTCODE 2620
    cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('2620')
...
//POSTCODE 2606
    cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('2606')
...
//POSTCODE 3000
    cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('3000')
...
//POSTCODE 3630
    cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('3630')
...
//POSTCODE 4000
    cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('4000')
...
//POSTCODE 4700
    cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('4700')
...
//POSTCODE 5606
    cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('5606')
...
//POSTCODE 6000
    cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('6000')
...
//POSTCODE 6330
    cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('6330')
...
//POSTCODE 7000
    cy.get('.SPC_WIDGET-MuiInputBase-input',{withinSubject:null}).type('7000')
